            ...
            .then(data => {
                ...
                if (globalBanner) {
                    ...
                    if (data.country === "IN") {
                        ...
                        globalBanner.innerHTML = "<div class='content'><p>Looking to invest in Indian Markets? Visit our US-specific Vested Finance RIA website to learn more.</p></div><a href='<?php echo site_url('/us/') ?>' class='learn_more_btn tmp'>Visit USA Website</a>";
                    } else {
