			...
			<div class="bonds_list_wrapper">
				...
				<div class="bonds_tabs_container">
					<div class="bonds_tabs_buttons">
						<button class="bonds_tab_button active" onclick="openTab('corporate_bonds')">Corporate
							Bonds</button>
												...
												<div class="bonds_slider_item_wrapper">
													<div class="bonds_slider_item_head">
														<div class="bond_image">
															...
															<img
																src="http://wordpress-testing.vestedfinance.com/wp-content/uploads/2024/04/Corporate-Bonds.png" />
														</div>
