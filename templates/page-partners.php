    ...
    <section class="home_features">
        <div class="container">
            <div class="home_features_wrapper">
                <h2 class="section_title">Explore Global Investment Opportunities</h2>
                <p class="section_desc">Choose from a wide range of asset classes designed to help you build a diversified global portfolio — whether you're starting small or aiming big.</p>
