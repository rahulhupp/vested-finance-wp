                                ...
                                <li>
                                    <?php if (get_sub_field('benefit_icon')): ?>
                                            <span class="benefit-icon">
                                                <?php echo get_sub_field('benefit_icon'); ?>
                                            </span>
                                    <?php endif; ?>
    ...
    <div class="container flex-box">
        <div class="about-mudrex-image">
            <?php if (get_field('about_mudrex_image')): ?>
                    <figure>
                        <img src="<?php the_field('about_mudrex_image'); ?>"
                            alt="<?php echo esc_attr(get_field('about_mudrex_title')); ?>">
                    </figure>
            <?php endif; ?>
        </div>
    ...
    <div class="container flex-box">
        ...
        <div class="accordionRow">
            <?php if (have_rows('investing_faqs')): ?>
                    <?php while (have_rows('investing_faqs')):
                        the_row(); ?>
