...
jQuery(document).ready(function ($) {
  ...
  function intervalOne() {
    if (
      ...
      var $progressBarOne = $(
        ".solar_slider_content .inProgress" + progressBarIndexOne
      );
      var $progressbarMobOne = $(
        ".solar_slider_content .slick-dots li .inProgress" + progressBarIndexOne
      );
      $progressBarOne
        .closest(".single_portfolio_slider_content")
  ...
  function resetProgressbarOne() {
    ...
    $(".single_portfolio_slider_content.slide-current").removeClass(
      "slide-current"
    );
  ...
  $(".solar_slider_content .single_portfolio_slider_content").click(
    function () {
      clearInterval(tickOne);
      var goToThisIndex = $(this).find("span").data("slickIndex");
      goToThisIndex = goToThisIndex - 1;
  ...
  $(".single_portfolio_slider_content[data-slick-index='0']").addClass(
    "slide-active"
  );

  $(".solar_slider_image").on(
    "beforeChange",
    function (event, slick, currentSlide) {
      var $activeSinglePortfolioSlider = $(this).find(
        ".single_portfolio_slider.slick-current"
      );
  ...
  $(".input_with_qty .minus").click(function () {
  ...
  $(".input_with_qty .plus").click(function () {
    var inputElement = $(this).siblings('input[type="number"]');
    var currentValue = parseInt(inputElement.val());
    inputElement.val(currentValue + 1);
  });

  var investAmtInput = $("#invest_amt_val");
  var amount = parseFloat(investAmtInput.val());
  if (!isNaN(amount)) {
    ...
    investAmtInput.val(formattedAmount);
