					...
					<?php if (has_tag('premium')) { ?>
						<div class="premium_box">
							<div class="premium_box_content">
								<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/permium-logo.svg"
									alt="premium_tag" class="premium_tag" />
								<h2>Continue reading on app</h2>
								<p>The content you are trying to access is available exclusively to Vested Premium subscribers.
									If you are an existing Premium subscriber, you can access this content on our mobile app.
								</p>
								<div class="premium_box_buttons">
									<a href="https://play.google.com/store/apps/details?id=com.vested.investing.android&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1"
										target="_blank">
										<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/permium-google-icon.svg"
											alt="google_play_store" />
									</a>
									<a href="https://apps.apple.com/us/app/vested-us-stocks-investing/id1478145933?ls=1"
										target="_blank">
										<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/permium-apple-icon.svg"
											alt="app_store" />
									</a>
								</div>
							</div>
				...
				<div class="chapter_cta_wrap">
					<div class="chapter_cta_content">
						<div class="vested_logo">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/Vested_logo.svg"
								alt="Vested Finance">
						</div>
						<?php
						...
						if ($single_cta_heading):
							?>
							<h3>
								<?php echo esc_html($single_cta_heading); ?>
							</h3>
						<?php else: ?>
							<h3>
								<?php echo esc_html($default_cta_heading); ?>
							</h3>
						<?php endif; ?>
					</div>
