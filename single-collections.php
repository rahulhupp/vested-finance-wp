    ...
    <div class="collection_page_banner smaller">
        <div class="container">
            <div class="collection_breadcrumb">
                <p><a href="#">US Stocks</a><span class="divider"> > </span><a href="<?php echo home_url('us-stock-collections'); ?>">All Collections</a><span class="divider"> > </span><span class="current_page"><?php the_title(); ?></span></p>
            </div>
            ...
            <div class="market_leaders_row">
                <div class="market_leaders_col">
                    ...
                    if ($terms && ! is_wp_error($terms)) :
                        ...
                        echo '<p>No categories found for this stock collection.</p>';
                    endif;
                        ...
                        <div class="market_table_headings">
                            ...
                            <div class="table_mobile_sort">
                                ...
                                <div class="table_sort_options">
                                    ...
                                    <ul>
                                        <li data-sort="price" data-order="asc" class="active">Price</li>
        ...
        <div class="strategies_sec">
            <div class="container">
                ...
                <div class="strategies_query">
                    <h3 class="que"><?php the_field('risk_que_question'); ?></h3>
