...
?>
<?php if (!isset($largest_holdings_data['error'])) { ?>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="holdings_stock_name">
                                                ...
                                                <?php } else { ?>
                                                    <img src="https://vestedfinance.com/wp-content/uploads/2023/10/Vested_logo-2.svg" alt="default-img" class="holdings_image" />
                                                <?php } ?>
