...
<script>
    ...
    function callOverviewApi() {
        const instrumentsApiUrl = 'https://vested-woodpecker-prod.vestedfinance.com/instrument/<?php echo $symbol; ?>/overview'; // Replace with the actual URL of the second API
