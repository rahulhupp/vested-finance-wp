<section class="explore-stock">
    <div class="container">
        ...
        <div class="explore-image">
            ...
            <ul>
                    ...
                    <a href="https://app.vestedfinance.com/stocks/AAPL" target="_blank" rel="noopener noreferrer">
                        <div class="box">
                            <div class="explore-icon">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/apple.png" />
                            </div>
                            <span>Apple</span>
                        </div>
                    </a>
                ...
                <li>
                    <a href="https://app.vestedfinance.com/stocks/AGPXX" target="_blank" rel="noopener noreferrer">
                        <div class="box">
                            <div class="explore-icon">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/invesco.png" />
                            </div>
                            <span>Invesco</span>
                        </div>
                    </a>
                ...
                <li>
                    <a href="https://app.vestedfinance.com/stocks/MSFT" target="_blank" rel="noopener noreferrer">
                        <div class="box">
                            <div class="explore-icon">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/microsoft.png" />
                            </div>
                            <span>Microsoft</span>
                        </div>
                    </a>
                ...
                <li>
                    <a href="https://app.vestedfinance.com/stocks/TSLA" target="_blank" rel="noopener noreferrer">
                        <div class="box">
                            <div class="explore-icon">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/tesla.png" />
                            </div>
                            <span>Tesla</span>
                        </div>
                    </a>
                ...
                <li>
                    <a href="https://app.vestedfinance.com/stocks/META" target="_blank" rel="noopener noreferrer">
                        <div class="box">
                            <div class="explore-icon">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/meta.png" />
                            </div>
                            <span>Meta</span>
                        </div>
                    </a>
                ...
                <li>
                    <a href="https://app.vestedfinance.com/stocks/NFLX" target="_blank" rel="noopener noreferrer">
                        <div class="box">
                            <div class="explore-icon">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/netflix.png" />
                            </div>
                            <span>Netflix</span>
                        </div>
                    </a>
                ...
                <li>
                    <a href="https://app.vestedfinance.com/stocks/BWX" target="_blank" rel="noopener noreferrer">
                        <div class="box">
                            <div class="explore-icon">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/spdr.png" />
                            </div>
                            <span>SPDR</span>
                        </div>
                    </a>
                ...
                <li>
                    <a href="https://app.vestedfinance.com/stocks/AMZN" target="_blank" rel="noopener noreferrer">
                        <div class="box">
                            <div class="explore-icon">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/amazon.png" />
                            </div>
                            <span>Amazon</span>
                        </div>
                    </a>
            ...
            <a class="btn_dark" href="#">Explore ALL US Stocks</a>
        </div>
