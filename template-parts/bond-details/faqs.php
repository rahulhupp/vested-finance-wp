        ...
        <div class="stock_details_box">
            ...
            <div class="faqs_section">
                <div class="faq_container">
                    <div class="list_faqs">
                        <div class="faq_item">
                            <div class="faq_question">How to buy <span class="faq-bond-name"></span> bond online?</div>
                            <div class="faq_icon">
                        ...
                        <div class="faq_answer">
                            <p>
                            Investing in <span class="faq-bond-name"></span> bond online is a simple process that can be completed in under 5 minutes. Follow these steps:
                            </p>
                    ...
                    <div class="faq_item">
                        <div class="faq_question">What is the yield of <span class="faq-bond-name"></span> bond?</div>
                        <div class="faq_icon">
                            <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 1L7 7L13 1" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
    ...
    <div class="stock_details_box">
        ...
        <div class="feedback_section">
            <div class="feedback_list" style="margin-right: 15px">
                <a href="" target="_blank" id="request_info_url">
                    <h2>Request to add more info/data</h2>
                </a>
            </div>
            <div class="feedback_list">
                <a href="" target="_blank" id="inform_data_url">
