    ...
    <script>
        ...
        function updateInvestmentDetails(data, unit) {
            ...
            if (cashflowResultLength > 0) {
                ...
                if (cashflowResultLength > 1) {
                    const secondDate = cashflowResult[1].date;
                    const secondLastIndex = cashflowResultLength - 2;
                ...
                document.querySelector('#cashflow-payout').innerHTML = '₹' + cashflowPayout.toLocaleString('en-IN');
                ...
                if (cashflowResultLength <= 1) {
                    ...
                    document.querySelectorAll('.second_last').forEach(element => {
                        element.style.display = 'none';
                    });
                } else {
                    document.querySelectorAll('.second').forEach(element => {
        ...
        var btns = document.querySelectorAll(".pdf_viewer");
