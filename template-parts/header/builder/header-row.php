...
if ( Astra_Builder_Helper::is_row_empty( $astra_header_row, 'header', 'desktop' ) ) {
	...
	?>
	<div class="inner-header ast-<?php echo esc_attr( $astra_row_label ); ?>-header-wrap <?php echo 'primary' === $astra_header_row ? 'main-header-bar-wrap' : ''; ?> ">
		<div class="<?php echo esc_attr( 'ast-' . $astra_header_row . '-header-bar ast-' . $astra_header_row . '-header' ); ?> <?php echo 'primary' === $astra_header_row ? 'main-header-bar' : ''; ?> site-header-focus-item" data-section="<?php echo esc_attr( $astra_customizer_editor_row ); ?>">
			...
			<div class="site-<?php echo esc_attr( $astra_header_row ); ?>-header-wrap ast-builder-grid-row-container site-header-focus-item ast-container" data-section="<?php echo esc_attr( $astra_customizer_editor_row ); ?>">
				<div class="logo-menu ast-builder-grid-row <?php echo Astra_Builder_Helper::has_side_columns( $astra_header_row ) ? 'ast-builder-grid-row-has-sides' : 'ast-grid-center-col-layout-only ast-flex'; ?> <?php echo Astra_Builder_Helper::has_center_column( $astra_header_row ) ? 'ast-grid-center-col-layout' : 'ast-builder-grid-row-no-center'; ?>">
					<?php if ( Astra_Builder_Helper::has_side_columns( $astra_header_row ) ) { ?>
						<div class="logo site-header-<?php echo esc_attr( $astra_header_row ); ?>-section-left site-header-section ast-flex site-header-section-left">
							<?php
								/**
						...
						<?php if ( Astra_Builder_Helper::has_side_columns( $astra_header_row ) ) { ?>
							<div class="main-menu site-header-<?php echo esc_attr( $astra_header_row ); ?>-section-right site-header-section ast-flex ast-grid-right-section">
								<?php
								if ( Astra_Builder_Helper::has_center_column( $astra_header_row ) ) {
									?>
								...
								<div class="mobile right-button">
									<?php
										wp_nav_menu(
											array(
												'theme_location' => 'secondary_menu', // Replace with the location you assigned.
												'menu_class' => 'menu-wrapper', // Add any additional classes for styling.
												'container_class' => 'account-menu', // Add a container class if needed.
			...
			<?php
				if (is_page_template('templates/page-home-page.php') || is_page_template('templates/page-us-stock-global.php') || is_page_template('templates/page-pricing-global.php') || is_page_template('templates/page-pricing-india.php') || is_page_template('templates/page-us.php') ) {
					?>
