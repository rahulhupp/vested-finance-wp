                ...
                <div class="footer_above_wrap">
                    <div class="site_info_col">
                        <div class="site_info_wrap">
                            <h2>
                                <a href="<?php echo site_url() ?>"><img src="<?php the_field('site_logo_us', 'option'); ?>" alt="Site Logo"></a>
                            </h2>
                                ...
                                <div class="app_wrap">
                                    <div class="single_app">
                                        <a href="<?php the_field('google_play_url_us', 'option'); ?>" target="_blank">
                                            <img src="<?php the_field('google_play_icon_us', 'option'); ?>" alt="Google Play Store">
                                        </a>
                                    </div>
                                    <div class="single_app">
                                        <a href="<?php the_field('apple_app_store_url_us', 'option'); ?>" target="_blank">
                                            <img src="<?php the_field('apple_app_store_icon_us', 'option'); ?>" alt="Apple App Store">
                                        </a>
                                    </div>
                                </div>
                                <?php if (have_rows('social_media_links_us', 'option')) : ?>
                                    <div class="footer_social_wrap">
                                        <?php while (have_rows('social_media_links_us', 'option')) : the_row(); ?>
                                            <a href="<?php the_sub_field('social_media_url_us'); ?>" class="footer_icon" target="_blank"><img src="<?php the_sub_field('social_media_icon_us'); ?>"></a>
                                        <?php endwhile; ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <?php while (have_rows('risk_disclosure_list_us', 'option')) : the_row(); ?>
                            <div class="single_disclosure_wrap">
                                ...
                                <div class="disclosure_heading">
                                    ...
                                    <img src="<?php the_sub_field('country_icon_us'); ?>" alt="">
                                </div>
