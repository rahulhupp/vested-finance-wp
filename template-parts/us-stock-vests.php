<section class="build-foundation">
    <div class="container">
        ...
        <div class="foundation-list">
            ...
            <div class="btn">
                <a class="btn_dark" href="#">Explore ALL Vests</a>
            </div>
        </div>
...
<script>
    ...
    function callVestsApi(token) {
        const vestsApiUrl = 'https://vested-api-staging.vestedfinance.com/v1/partner/vests-list';
    ...
    function getVestsList(vests) {
        ...
        defaultBox.innerHTML = `
            <a href="https://app.vestedfinance.com/diy-vests" target="_blank" class="inner">
                <div class="plus-icon">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/img/plus-icon.png" />
                </div>
                <div class="content">
