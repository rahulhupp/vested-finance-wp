...
while (have_posts()):
	...
	$previous_post = get_previous_post(true, '', 'announcements');
	$next_post = get_next_post(true, '', 'announcements');
	?>
				...
				<div class="container">
					<div class="announcements_heading_content">
						<div class="single_announcements_breadcrumb">
							...
							$terms = get_the_terms(get_the_ID(), 'announcements');
							?>
							<ul>
								<li>
								...
								<li>
									<a href="<?php echo home_url(); ?>/in/announcements/">Announcements</a>
								</li>
								<?php
								$post_id = get_the_ID();
